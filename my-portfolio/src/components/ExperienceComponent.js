...
export default function ExperienceComponent() {
  return (
    <Card id = "experience" className='sm:m-5 md:m-10 lg:m-20 xl:m-32 m-2'>
      <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
        Tech Experience
      </h5>

      <Card className='m-4'>
        <img alt='lume' src='/images/lume.png' className='w-20 h-20 mr-4'/>
      ...
      <Card className='m-4'>
        <img alt='level access' src='/images/levelAccess.jpg' className='w-20 h-20 mr-4'/>
      ...
      <Card className='m-4'>
        <img alt='teaching pics' src='/images/teaching.png' className='w-20 h-20 mr-4'/>
        <div>
      ...
      <Card className='m-4'>
        <img alt='carletonU' src='/images/carleton.png' className='w-20 h-20 mr-4'/>
      ...
      <Card className='m-4'>
        <img alt='leaside' src='/images/Leaside.png' className='w-20 h-20 mr-4'/>
